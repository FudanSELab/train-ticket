...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.httpBasic().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/api/v1/foodbooking/**").permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/v1/foodbooking/orders/*").hasAnyRole(admin)
                .antMatchers(HttpMethod.PUT, "/api/v1/foodbooking/orders").hasAnyRole(admin)
                .antMatchers(HttpMethod.POST, "/api/v1/foodbooking/orders").hasAnyRole(admin)
