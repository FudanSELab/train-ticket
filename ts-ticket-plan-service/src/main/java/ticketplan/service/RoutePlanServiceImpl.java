...
public class RoutePlanServiceImpl implements RoutePlanService {
    ...
    public Response searchCheapestResult(RoutePlanInfo info, HttpHeaders headers) {
        ...
        for (TripResponse tempResponse : returnResult) {
    ...
    public Response searchMinStopStations(RoutePlanInfo info, HttpHeaders headers) {
        ...
        LOGGER.info("[searchMinStopStations][Get the route][Candidate Route Number: {}]", routeList.size());
        ...
        LOGGER.info("[searchMinStopStations][Get train Information][Trips Num: {}]", finalTripResult.size());
        ...
        LOGGER.info("[searchMinStopStations][Trips Response Unit Num: {}]", tripResponses.size());
    ...
    private Route getRouteByRouteId(String routeId, HttpHeaders headers) {
        ...
        if (result.getStatus() == 0) {
            LOGGER.error("[getRouteByRouteId][Get Route By Id Fail][RouteId: {}]", routeId);
            return null;
        } else {
    ...
    private ArrayList<TripResponse> getTripFromHighSpeedTravelServive(TripInfo info, HttpHeaders headers) {
        LOGGER.info("[getTripFromHighSpeedTravelServive][trip info: {}]", info);
        ...
        LOGGER.info("[getTripFromHighSpeedTravelServive][Route Plan Get Trip][Size:{}]", tripResponses.size());
    ...
    private ArrayList<TripResponse> getTripFromNormalTrainTravelService(TripInfo info, HttpHeaders headers) {
        ...
        LOGGER.info("[getTripFromNormalTrainTravelService][Route Plan Get Trip][Size:{}]", list.size());
        return list;
    }
